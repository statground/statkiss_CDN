  ...
  function HeaderAdminButton({ user, t }) {
    ...
    return (
      <a
        ...
        className="statkiss-toplink inline-flex items-center rounded-full border border-slate-200 bg-white dark:border-slate-700/60 dark:bg-slate-900/40 px-3 py-2 text-sm font-semibold shadow-sm hover:bg-slate-50 text-slate-700 dark:text-white"
      >
        {t('auth.admin')}
      </a>
    );
