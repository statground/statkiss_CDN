function click_dropdown(id) {
	...
	if (id == "announcement" && !toggle_menu_announcement) {
		document.getElementById("div_megamenu_announcement").className = class_div_sub_menu_pc
		document.getElementById("div_menu_mobile_announcement").className = class_div_sub_menu_mobile
		toggle_menu_announcement = true
	} else {
		document.getElementById("div_megamenu_announcement").className = "hidden"
		document.getElementById("div_menu_mobile_announcement").className = "hidden"
		toggle_menu_announcement = false
	}
	...
	if (id == "membership" && !toggle_menu_membership) {
		document.getElementById("div_megamenu_membership").className = class_div_sub_menu_pc
		document.getElementById("div_menu_mobile_membership").className = class_div_sub_menu_mobile
		toggle_menu_membership = true
	} else {
		document.getElementById("div_megamenu_membership").className = "hidden"
		document.getElementById("div_menu_mobile_membership").className = "hidden"
		toggle_menu_membership = false
	}
}