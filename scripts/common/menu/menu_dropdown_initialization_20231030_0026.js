...
function menu_dropdown_initialization() {
	...
	document.getElementById("mega_menu_dropdown_announcement").className = "hidden"
	toggle_menu_dropdown_announcement = 0
	...
	document.getElementById("mega_menu_dropdown_membership").className = "hidden"
	toggle_menu_dropdown_membership = 0
}