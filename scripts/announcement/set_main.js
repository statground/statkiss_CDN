...
function set_main() {
  ...
  function EditorApp() {
    ...
    if (loading) return <BusyCard lang={lang} mode="loading" />;
    ...
    return (
      <div className="py-6 px-4 mx-auto max-w-screen-xl sm:py-10 lg:px-6">
        <div className="sk-ann-surface space-y-6 rounded-3xl border border-slate-200 bg-slate-50 p-6 shadow-sm md:p-8">
          ...
          <div className="flex flex-wrap justify-end gap-2">
            <button type="button" onClick={handleSubmit} disabled={saving} className="inline-flex items-center justify-center rounded-full bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-70">
