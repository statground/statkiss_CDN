...
function set_main() {
  ...
  function injectSolidEditorEmbedStyles() {
    ...
    style.textContent = `
      ...
      .sk-ann-editor-host .lre-doc-title {
        display: none !important;
      }
      .sk-ann-editor-host .lre-editor-page {
        width: 100% !important;
  ...
  function hasSolidEditorMountApi() {
    return typeof window.mountLocalRichEditor === "function";
  }
    ...
    return new Promise((resolve, reject) => {
      ...
      function poll() {
        if (hasSolidEditorMountApi()) {
          resolve(window.mountLocalRichEditor);
          return;
        }
        attempts += 1;
  ...
  function ensureSolidEditorScript() {
    if (hasSolidEditorMountApi()) return Promise.resolve(window.mountLocalRichEditor);
  ...
  function mountSolidEditorHost(host, options) {
    ...
    return window.mountLocalRichEditor(Object.assign({
      target: host,
      replace: true,
      persist: false,
    }, options || {}));
