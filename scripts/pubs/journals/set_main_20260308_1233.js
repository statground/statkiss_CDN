function set_main() {
    ...
    function Div_person_li(props) {
        return (
            <li class="flex items-start">
                <svg class={isDarkModeEnabled() ? 'w-4 h-4 mr-2 mt-1 shrink-0 text-white' : 'w-4 h-4 mr-2 mt-1 shrink-0 text-gray-700'} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <div class="flex flex-col">
                    <span class={isDarkModeEnabled() ? 'text-md text-white font-medium' : 'text-md text-gray-900'}>{props.name}</span>
                    <span class={isDarkModeEnabled() ? 'text-xs text-gray-200' : 'text-xs text-gray-500'}>({props.affiliation})</span>
                </div>
            </li>
        )
    }
    ...
    function App() {
        ...
        const editorialBoardTitleClass = isDark ? 'mb-8 text-2xl font-bold text-white' : 'mb-8 text-2xl font-bold text-gray-900';
        const editorialRoleClass = isDark ? 'text-md leading-tight text-white' : 'text-md leading-tight text-gray-700';
        const editorialListClass = isDark ? 'max-w-md space-y-1 text-gray-100 list-disc list-inside' : 'max-w-md space-y-1 text-gray-500 list-disc list-inside';
        ...
        return (
            <div class="flex flex-col">
                ...
                <div class="px-4 mx-auto max-w-screen-xl py-8">
                    <h2 class={editorialBoardTitleClass}>{t.editorial_board_title}</h2>
                    <div class="grid grid-cols-1 lg:grid-cols-5 gap-12">
                        <div class="w-full max-w-full md:max-w-xs">
                            <div class="flex flex-col w-full min-h-[50px] justify-center items-center mb-2 text-center">
                                <p class={editorialRoleClass}>{t.editor_in_chief}</p>
                            </div>
                            <ul class={editorialListClass}>
                        ...
                        <div class="w-full max-w-full md:max-w-xs">
                            <div class="flex flex-col w-full min-h-[50px] justify-center items-center mb-2 text-center">
                                <p class={editorialRoleClass}>{t.co_editors}</p>
                            </div>
                            <ul class={editorialListClass}>
                        ...
                        <div class="w-full max-w-full md:max-w-xs">
                            <div class="flex flex-col w-full min-h-[50px] justify-center items-center mb-2 text-center">
                                <p class={editorialRoleClass}>{t.honorary_editors}</p>
                            </div>
                            <ul class={editorialListClass}>
                        ...
                        <div class="w-full max-w-full md:max-w-xs">
                            <div class="flex flex-col w-full min-h-[50px] justify-center items-center mb-2 text-center">
                                <p class={editorialRoleClass}>{t.managing_editor}</p>
                            </div>
                            <ul class={editorialListClass}>
                        ...
                        <div class="w-full max-w-full md:max-w-xs">
                            <div class="flex flex-col w-full min-h-[50px] justify-center items-center mb-2 text-center">
                                <p class={editorialRoleClass}>{t.editorial_assistant}</p>
                            </div>
                            <ul class={editorialListClass}>
