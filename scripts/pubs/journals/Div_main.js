		...
		<div class="flex flex-col">
			<div class="bg-[url('https://cdn.jsdelivr.net/gh/statground/statkiss_CDN/images/journal/header_blank.png')] bg-no-repeat bg-cover bg-center">
				<div class="relative py-8 px-4 mx-auto max-w-screen-xl lg:py-16 z-1">
					...
					<div class="grid grid-cols-3 gap-8 pt-8 lg:pt-12 mt-8 lg:mt-12 border-t border-gray-600 sm:grid-cols-1 w-full">
						...
						<Div_sub_card text={"A Korean manual for e-submission"}
									  url={"https://www.statkiss.org/wp-content/uploads/2014/11/Author_manual_Kor.pdf"} url_name={"Manual"} />
					</div>
