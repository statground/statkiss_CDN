                ...
                <div class={palette.sectionCard}>
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
                            <button
                                type="button"
                                class={botCleanupActionButtonClass(themeMode, 'warning')}
                            ...
                            <button
                                type="button"
                                class={botCleanupActionButtonClass(themeMode, 'success')}
                                onClick={() => window.member_patch_clear_bot_review_action(key, member.email)}>
                                {admin_t('members.bot.action.clear')}
                            </button>
                            <button
                                type="button"
                                class={botCleanupActionButtonClass(themeMode, 'danger')}
