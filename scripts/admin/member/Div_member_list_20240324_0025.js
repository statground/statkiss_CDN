		...
		<div class="flex flex-col bg-white rounded-lg border border-gray-500 shadow-sm p-2 space-y-2 hover:bg-gray-100">
			...
			<div class="flex flex-row justify-start items-center w-full space-x-2">
					...
					<select id={"sel_membership_" + props.data[article].uuid}
						...
						{
							props.data[article].role == "Spauce Member" 
							?   <option value="Spauce Member" selected>Spauce Member</option>
							:   <option value="Spauce Member">Spauce Member</option>
						}

						{
							props.data[article].role == "KSS Joint Member" 
							?   <option value="KSS Joint Member" selected>KSS Joint Member</option>
							:   <option value="KSS Joint Member">KSS Joint Member</option>
						}
