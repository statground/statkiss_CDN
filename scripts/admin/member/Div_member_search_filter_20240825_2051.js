			...
			<div class="flex flex-col w-full justify-end items-center space-x-4 px-8 py-4 bg-blue-100 border border-blue-300 shadow space-y-4 rounded-lg md:px-2">
				...
				<div class="flex flex-col justify-center items-center w-full space-y-1">
					...
					<ul class="grid grid-cols-3 items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg">
						...
						<div class="flex items-center ps-3">
							<input id="check_member_spouse" type="checkbox" value="" 
								class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500" />
							<label for="check_member_spouse" class="w-full py-3 ms-2 text-sm font-medium text-gray-900">Spouse Member</label>
						</div>
						<div class="flex items-center ps-3">
						...
						<div class="flex items-center ps-3">
							<input id="check_member_member" type="checkbox" value=""
								class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500" />
							<label for="check_member_member" class="w-full py-3 ms-2 text-sm font-medium text-gray-900">Non-member</label>
						</div>
					</ul>
				</div>
				...
				<div class="flex flex-col justify-center items-center w-full space-y-1">
					...
					<ul class="grid grid-cols-3 items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg">
						...
						<div class="flex items-center ps-3">
							<input id="check_member_addon_kssjoint" type="checkbox" value=""
								class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500" />
							<label for="check_member_addon_kssjoint" class="w-full py-3 ms-2 text-sm font-medium text-gray-900">KSS Joint Member</label>
						</div>
					</ul>
				</div>
