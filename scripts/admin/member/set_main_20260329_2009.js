                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            <p class={'text-sm font-semibold ' + palette.heading}>{admin_t('admin.common.membership')}</p>
                            <div class="flex flex-wrap gap-2">
                                <button type="button" class={palette.secondaryBtn} onClick={() => member_patch_toggle_membership_filters(true)}>{admin_t('members.search.select_all')}</button>
                                <button type="button" class={palette.secondaryBtn} onClick={() => member_patch_toggle_membership_filters(false)}>{admin_t('members.search.clear_all')}</button>
                            </div>
                        </div>
                        <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
                            {checkboxItem('check_member_admin', admin_t('admin.roles.admin') + ', ' + admin_role_label('Developer'))}
