...
// ===== Bot review action flow override 2026-04-12k =====
;(function () {
    if (!window.StatKISS_ADMIN_I18N || typeof window.StatKISS_ADMIN_I18N.register !== 'function') {
        return;
    }
    ...
    const override = {
        en: {
            'members.bot.toggle.open': 'Bot account review',
            'members.bot.toggle.close': 'Hide Bot review',
            'members.bot.action.clear': 'Clear Bot suspicion',
            'members.bot.action.mark_review': 'Bot suspected',
            'members.bot.action.mark_suspected': 'Confirm Bot',
            'members.bot.confirm.clear': 'Clear the Bot suspicion for this account?',
            'members.bot.confirm.mark_review': 'Move this account to the Bot suspected review state?',
            'members.bot.confirm.mark_suspected': 'Confirm this account as a Bot account?',
            'members.bot.form.current_state': 'Current state',
            'members.bot.form.reason_label': 'Reason',
            'members.bot.form.apply': 'Apply',
            'members.bot.reason_placeholder.management': 'Write why this account should stay in Bot suspected review or be confirmed as Bot.',
            'members.bot.reason_placeholder.review': 'Edit the saved review reason for this account.',
            'members.bot.status.review_queue': 'Bot suspected',
            'members.bot.status.discarded': 'Bot confirmed',
            'members.bot.status.cleared': 'Bot suspicion cleared',
            'members.bot.filter.review': 'Bot suspected',
            'members.bot.filter.suspected': 'Bot confirmed',
            'members.bot.filter.cleared': 'Bot suspicion cleared',
            'members.bot.badge.review': 'Bot suspected',
            'members.bot.badge.suspected': 'Bot confirmed',
            'members.bot.badge.cleared': 'Bot suspicion cleared',
            'members.bot.alert.reason_required': 'Please enter a reason first.',
        },
        ko: {
            'members.bot.toggle.open': 'Bot 계정 검토',
            'members.bot.toggle.close': 'Bot 검토 닫기',
            'members.bot.action.clear': 'Bot 의심 해제',
            'members.bot.action.mark_review': 'Bot 의심',
            'members.bot.action.mark_suspected': 'Bot 확정',
            'members.bot.confirm.clear': '이 계정의 Bot 의심 상태를 해제하시겠습니까?',
            'members.bot.confirm.mark_review': '이 계정을 Bot 의심 상태로 두시겠습니까?',
            'members.bot.confirm.mark_suspected': '이 계정을 Bot 확정 상태로 바꾸시겠습니까?',
            'members.bot.form.current_state': '현재 상태',
            'members.bot.form.reason_label': '근거',
            'members.bot.form.apply': '적용',
            'members.bot.reason_placeholder.management': '이 계정을 Bot 의심 또는 Bot 확정으로 처리하는 근거를 적어 주세요.',
            'members.bot.reason_placeholder.review': '저장된 근거를 수정하거나 다음 조치에 쓸 근거를 적어 주세요.',
            'members.bot.status.review_queue': 'Bot 의심',
            'members.bot.status.discarded': 'Bot 확정',
            'members.bot.status.cleared': 'Bot 의심 해제',
            'members.bot.filter.review': 'Bot 의심',
            'members.bot.filter.suspected': 'Bot 확정',
            'members.bot.filter.cleared': 'Bot 의심 해제',
            'members.bot.badge.review': 'Bot 의심',
            'members.bot.badge.suspected': 'Bot 확정',
            'members.bot.badge.cleared': 'Bot 의심 해제',
            'members.bot.alert.reason_required': '근거를 먼저 입력해 주세요.',
        },
    };

    window.StatKISS_ADMIN_I18N.register('members_bot_action_flow_override_20260412k', override);
    ...
    try {
        ...
        console.warn('members_bot_action_flow_override_20260412k override failed', error);
    }
})();
