function Div_member_list_membership(props) {
	return (
		<div class="flex flex-wrap justify-center items-center w-full space-x-2">
			...
			{
				props.current_role == "Spauce Member" 
				?   <p id={"membership_spauce_" + props.uuid_user} class={class_member_active + " bg-purple-200"}>Spauce Member</p>
				:   <p id={"membership_spauce_" + props.uuid_user} class={class_member_deactive + " hover:bg-gray-100 hover:text-gray-900 hover:shadow cursor-pointer"}
					   onClick={() => click_btn_change_membership(props.uuid_user, "Spauce Member", props.current_role)}>Spauce Member</p>
			}
