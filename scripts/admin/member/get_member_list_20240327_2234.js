async function get_member_list(mode) {
	...
	if (mode == "init") { 
		...
		document.getElementById("check_member_spause").checked = true
	...
	check_member_spause = "NO"
	if (document.getElementById("check_member_spause").checked) {    check_member_spause = "YES"; }
	...
	request_data.append('check_member_spause', check_member_spause);
