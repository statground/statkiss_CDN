async function get_officer_list() {
	...
	let data_res = {}
	data_res["current"] = Object.values(data).filter(it => it.role != "Board of Directors" && it.role != "Incoming Board Member")
	...
	ReactDOM.render(<Div_current_officers term={data_res["current"][0].term} data={data_res["current"]} />, document.getElementById("div_current_officers"))
