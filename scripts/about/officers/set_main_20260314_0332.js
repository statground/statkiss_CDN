(function () {
  ...
  function injectFallbackCSS() {
    ...
    style.textContent = `
      html.dark .statkiss-officers-page { color: #e5e7eb; }
      ...
      html.dark .statkiss-officers-incoming-title { color: #f8fafc !important; }
      html.dark .statkiss-officers-subtitle,
      html.dark .statkiss-officers-muted,
      html.dark .statkiss-officers-incoming-meta { color: #cbd5e1 !important; }
      ...
      html.dark .statkiss-officers-error { background: #0f172a !important; border-color: #1f2937 !important; }
      html.dark .statkiss-officers-badge { background: rgba(148, 163, 184, 0.15) !important; color: #cbd5e1 !important; }
      html.dark .statkiss-officers-badge--highlight { background: rgba(56, 189, 248, 0.16) !important; color: #bae6fd !important; }
      html.dark .statkiss-officers-board-dot { background: #38bdf8 !important; }
      html.dark .statkiss-officers-incoming-wrap { background: rgba(16, 185, 129, 0.08) !important; border-color: rgba(16, 185, 129, 0.18) !important; }
      html.dark .statkiss-officers-retry { background: rgba(56, 189, 248, 0.16) !important; color: #e0f2fe !important; border-color: rgba(56, 189, 248, 0.25) !important; }
    `;
