			...
			<section class="bg-white">
				<div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
					<div class="mx-auto max-w-screen-lg text-center">
						<h2 class="mb-2 text-4xl tracking-tight font-extrabold text-gray-900">Constitution</h2>
						<p class="mb-8 text-gray-500 lg:text-lg">
							Constitution of the Korean International Statistical Society
						</p>
					</div>
					...
					<div class="flex flex-col pt-8 text-left border-t border-gray-200">
						<div class="mb-10 px-4">
							...
							<div class="mb-4 text-md text-gray-500 space-y-4">
								<p class="mb-4 text-md text-gray-500 space-y-4">
