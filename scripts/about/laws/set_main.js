			...
			<section class="bg-white">
				<div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
					<div class="mx-auto max-w-screen-lg text-center">
						<h2 class="mb-2 text-4xl tracking-tight font-extrabold text-gray-900">By Laws</h2>
						<p class="mb-8 text-gray-500 lg:text-lg">
							By-laws of the Korean International Statistical Society
						</p>
					</div>
					
					<div class="flex flex-col pt-8 text-left border-t border-gray-200">
						<div class="mb-10 px-4">
							<h3 class="mb-4 text-lg font-medium text-gray-900">
								ARTICLE 1. MEMBERSHIP
							</h3>
							<div class="mb-4 text-md text-gray-500 space-y-4">

								<ol class="space-y-4 text-gray-500 list-decimal list-inside">
									<li class="text-gray-500">
										Members. Members are classified into the following categories:<br/>
										Individual members: An individual member shall be a person interested in the objectives of the Society whose application for membership is approved by the Board of Directors. The Board of Directors may delegate the function of approval.<br/>
						...
						<div class="mb-10 px-4">
							...
							<div class="mb-4 text-md text-gray-500 space-y-4">
								<ol class="space-y-4 text-gray-500 list-decimal list-inside">
									<li class="text-gray-500">
										Definition: A cooperating or associated society is a nonprofit organization interested in the objectives of the Society and concerned with the advancement of the statistical methodology or of its application.
									</li>
									<li class="text-gray-500">
										Procedure: The Board of Directors of the Society may enter upon cooperative working arrangements with such organizations for promoting the objectives of the Society. Such cooperative working arrangements may include:
									...
									<li class="text-gray-500">
										Limitations on the Procedures: No cooperative working arrangement may be entered into by the Board of Directors which:
									<ul class="pl-5 mt-2 space-y-1 list-disc list-inside">
										<li>
						...
						<div class="mb-10 px-4">
							...
							<div class="mb-4 text-md text-gray-500 space-y-4">
								...
								<ol class="space-y-4 text-gray-500 list-decimal list-inside">
									<li class="text-gray-500">
										Methods of Nomination: Three months before the annual meetings, the Nominating Committee shall:
										<ul class="pl-5 mt-2 space-y-1 list-disc list-inside">
											<li>
										...
										The Nominating Committee is charged with full responsibility of the submission of nominations as described in the preceding paragraphs. Additional candidates on the ballot for any elected office may be made by a petition signed by at least ten percent (10%) of the Society’s individual members.<br/>
										Two months before the annual meeting, the Executive Director shall mail or email to individual members a ballot for the election to office from the persons nominated, along with a brief biographic sketch of each nominee.<br/>
									...
									<li class="text-gray-500">
										Vacancies in Office: Except as provided for below, or in ARTICLE 6, Section 6.1, the Board of Directors shall fill any vacancy on the Board which occurs between elections.<br/>
						...
						<div class="mb-10 px-4">
							...
							<div class="mb-4 text-md text-gray-500 space-y-4">
								...
								<ol class="space-y-4 text-gray-500 list-decimal list-inside">
									...
									<li class="text-gray-500">
										Standing Committees: The Standing Committees are listed below.
										<ul class="pl-5 mt-2 space-y-1 list-disc list-inside">
											<li>
						...
						<div class="mb-10 px-4">
							...
							<div class="mb-4 text-md text-gray-500 space-y-4">
								...
								<ol class="space-y-4 text-gray-500 list-decimal list-inside">
									<li class="text-gray-500">
										Editorial Boards: Each periodical published by the Association shall have an Editorial Board, consisting of all its Editors and such other personnel as may be designated by each Editor. The terms of Editors shall be determined by the Publication Committee.
									</li>
									<li class="text-gray-500">
									...
									<li class="text-gray-500">
										At suitable intervals, a directory of all classes of members, the Constitution and the By-Laws of the Association shall be published and sent to each member.
									</li>
								 </ol>
							</div>
						</div>
						...
						<div class="mb-10 px-4">
							...
							<div class="mb-4 text-md text-gray-500 space-y-4">
								...
								<ol class="space-y-4 text-gray-500 list-decimal list-inside">
									...
									<li class="text-gray-500">
										Resolutions and recommendations of Sections or Committees of the Association shall be so phrased as not to commit the Association or its membership.
									</li>
								 </ol>
							</div>
						</div>
