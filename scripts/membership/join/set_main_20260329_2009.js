function set_main() {
    ...
    function render(target, state) {
        ...
        const buttonDisabledAttr = selected.is_free && studentUi && studentUi.disabled ? ' disabled aria-disabled="true"' : '';
        const buttonDisabledClass = selected.is_free && studentUi && studentUi.disabled ? ' opacity-70 cursor-not-allowed hover:translate-y-0' : '';
