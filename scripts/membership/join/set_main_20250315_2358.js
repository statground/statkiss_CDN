function set_main() {
    const Div_main = () => {
        const class_card = "flex flex-col p-4 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-300 shadow w-full h-full hover:bg-blue-100"
        ...
        return (
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 space-y-4">
                ...
                <div class="grid grid-cols-2 w-full text-gray-900 px-4 gap-4 md:grid-cols-1">
                    <div class={class_card}>
                        ...
                        <div class="flex w-full justify-center items-baseline">
                            <form action="https://www.paypal.com/donate" method="post">
                                <input type="hidden" name="business" value="kim3h4@ucmail.uc.edu" />
                    ...
                    <div class={class_card}>
                        <Div_sub_title title={"Lifetime Member"} price={"$500"} />
                ...
                <div class="grid grid-cols-3 w-full text-gray-900 px-4 gap-4 md:grid-cols-1">
                    ...
                    <div class={class_card}>
                        ...
                        <div class="flex w-full justify-center items-baseline">
                            <button class="bg-yellow-400 font-extrabold rounded-full text-sm px-5 py-1 me-2 mb-2 shadow
                                           hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-300"
