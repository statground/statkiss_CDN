function set_main() {
    ...
    async function fetchStudentMembershipStatus() {
        try {
            const response = await fetch(buildMembershipAjaxUrl('ajax_add_student_membership/'), { method: 'GET' });
        ...
        if (button) {
            button.addEventListener("click", async () => {
                ...
                if (currentSelected.is_free) {
                    ...
                    render(target, state);
                    try {
                        const response = await fetch(buildMembershipAjaxUrl('ajax_add_student_membership/'), {
                            method: 'POST',
