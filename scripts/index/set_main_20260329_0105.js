...
function set_main() {
  ...
  function stripHtml(str) {
    if (!str) return "";
    // Strip tags, decode entities, then remove raw URLs/emails shown in previews on index.
    // We keep the article body intact on read pages; this only affects index/list previews.
