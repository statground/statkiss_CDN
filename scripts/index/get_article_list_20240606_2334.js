async function get_article_list() {
	function Div_section(props) {
		return (
			<a class="w-full p-2 cursor-pointer rounded-lg hover:bg-blue-100 hover:border hover:border-blue-300 hover:shadow"
				href={'/announcement/' + props.url + '/read/' + props.uuid + '/'}>
	...
	function Div_main_latest_news(props) {
		return (
			<div class="flex flex-col justiy-center items-center bg-blue-100 w-full py-4">
				...
				<div class="grid grid-cols-3 w-full max-w-screen-xl md:grid-cols-1 md:gap-12 md:space-y-0">
					{
