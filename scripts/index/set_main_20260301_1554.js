...
function set_main() {
  ...
  (function injectDarkFallback(){
    ...
    style.textContent = `
      ...
      html.dark .kiss-card { background-color:#0b1220 !important; border-color:#1e293b !important; }
      html.dark .kiss-muted { color:#94a3b8 !important; }
      html.dark .kiss-border { border-color:#1e293b !important; }
      ...
      html.dark .kiss-main-bg .border-slate-200 { border-color:#1e293b !important; }
      html.dark .kiss-main-bg .divide-slate-50 { border-color:#1e293b !important; }
      ...
      html.dark .kiss-main-bg .shadow-md { box-shadow: 0 20px 50px rgba(0,0,0,.45) !important; }
          ...
          {loading ? (
            ...
            cur.list.slice(0,5).map(item => (
              <a key={item.uuid} href={articleHref(item)}
                className="block rounded-xl border border-slate-100 bg-white p-4 shadow-sm transition-all hover:border-indigo-200 hover:shadow-md dark:bg-slate-900 dark:border-slate-800">
