...
function set_main() {
  ...
  (function injectDarkFallback(){
    ...
    style.textContent = `
      ...
      html.dark .kiss-card { background-color:#0b1220 !important; border-color:#1f2937 !important; }
      html.dark .kiss-muted { color:#94a3b8 !important; }
      html.dark .kiss-border { border-color:#1f2937 !important; }
      ...
      html.dark .kiss-main-bg .border-slate-200 { border-color:#1f2937 !important; }
      html.dark .kiss-main-bg .divide-slate-50 { border-color:#1f2937 !important; }
      ...
      html.dark .kiss-main-bg .shadow-md { box-shadow: 0 20px 50px rgba(0,0,0,.55) !important; }
    `;
