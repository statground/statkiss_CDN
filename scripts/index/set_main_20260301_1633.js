...
/* Dark: remove the light frame (wrapper background/padding) around bulletin cards */
html.dark .kiss-main-bg .bulletin-list { background-color: transparent !important; padding: 0 !important; }
body.dark .kiss-main-bg .bulletin-list { background-color: transparent !important; padding: 0 !important; }
.dark .kiss-main-bg .bulletin-list { background-color: transparent !important; padding: 0 !important; }

/* Dark: ensure bulletin items have no outline/shadow of any kind */
html.dark .kiss-main-bg .bulletin-item,
body.dark .kiss-main-bg .bulletin-item,
.dark .kiss-main-bg .bulletin-item {
  border: none !important;
  outline: none !important;
  box-shadow: none !important;
}
          ...
          {loading ? (
            ...
            cur.list.slice(0,5).map(item => (
              <a key={item.uuid} href={articleHref(item)}
                className="bulletin-item block rounded-xl border border-slate-100 bg-white p-4 shadow-sm transition-all hover:border-indigo-200 hover:shadow-md dark:bg-slate-900 dark:border-transparent dark:shadow-none dark:hover:border-transparent dark:hover:shadow-none">
