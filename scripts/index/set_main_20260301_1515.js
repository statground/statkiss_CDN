...
function set_main() {
  ...
  function HeroSection({ articleData, loading, lang, isDesktop }) {
    ...
    return (
      <section className="mx-auto max-w-6xl px-6 pt-8 pb-6">
        <div className="rounded-3xl bg-white p-6 shadow-xl shadow-slate-900/5 dark:bg-slate-900">
          {isDesktop ? (
  ...
  function BulletinSection({ loading, articleData, lang }) {
    ...
    return (
      <section className="flex flex-col rounded-3xl bg-white p-6 shadow-xl shadow-slate-900/5 dark:bg-slate-900">
        <div className="mb-5">
