...
function set_main() {
  ...
  (function injectDarkFallback(){
    ...
    style.textContent = `
      ...
      \n      html.dark .kiss-main-bg .bulletin-item { background-color: rgba(255,255,255,0.035) !important; border-color: rgba(148,163,184,0.14) !important; box-shadow: none !important; }\n      
