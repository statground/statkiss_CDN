					...
					<div class="flex flex-col justify-center items-center text-start w-full space-y-[12px]">
						...
						<div class="flex flex-row justify-center items-center w-full ">
							...
							<p class="text-sm">Password recovery function may not work properly. <br/>
                                               In the case you encounter a difficulty, please reach out to Membership Director Dr. Seonjin Kim at <span class="text-blue-500 hover:text-blue-700">kim20@miamioh.edu</span> with a subject heading of “KISS member log-in issue”. </p>
						</div>
