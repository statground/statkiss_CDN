window.set_main = function () {
    ...
    function connectionCard(userinfo) {
        ...
        const body = [
            ...
            '  </div>',
            '</dl>',
            '<div class="rounded-xl border border-slate-200 bg-white px-4 py-4 text-sm text-slate-600 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-300">' + ui.escapeHtml(ui.t('myinfo_manage_connections_desc')) + '</div>',
