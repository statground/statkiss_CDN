...
(function () {
    ...
    const SUPPORTED_LANGS = (HeaderI18N && Array.isArray(HeaderI18N.languages) ? HeaderI18N.languages.map((item) => item.code) : ["en", "ko", "ja", "zh-Hans", "zh-Hant", "es", "fr", "de", "pt-BR", "ru", "id", "vi", "th", "ms", "fil", "hi", "ar", "it", "nl", "pl", "sv", "tr", "uk"]);
  ...
  "uk": {
    ...
    const supportEmail = 'info@statkiss.org';
    ...
    const routes = {
        ...
        home: localizeInternalPath('/'),
    };

    const api = {
        signin: buildPathCandidates('ajax_signin_email/'),
        signup: buildPathCandidates('ajax_signup/'),
        getUserinfo: buildPathCandidates('ajax_get_userinfo/'),
        updateUserinfo: buildPathCandidates('ajax_update_userinfo/'),
        sendAuthEmail: buildPathCandidates('ajax_send_auth_email/'),
        checkAuthCode: buildPathCandidates('ajax_check_auth_code/'),
        passwordChange: buildPathCandidates('ajax_password_change/'),
    };
