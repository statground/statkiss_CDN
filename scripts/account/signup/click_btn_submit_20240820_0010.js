async function click_btn_submit() {
	if (!toggle_signup_btn_submit) {
		...
		// Spinner
		ReactDOM.render(<Div_btn_submit_spinner class={class_btn_enabled + " cursor-not-allowed"} function={null} text={"Sign Up"} />, document.getElementById("btn_submit"))
		...
		inputData.append('chk_student', document.getElementById("chk_student").checked);
