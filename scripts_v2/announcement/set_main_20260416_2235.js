...
(function initStatkissAnnouncementShared() {
    ...
    try { window.__STATKISS_THEME_ANNOUNCEMENT_PATCH__ = "20260416-themefix3"; } catch (_) {}
    ...
    function injectAnnouncementThemeFallback() {
      ...
      html[data-theme="dark"] .sk-ann-fab--ghost,
      ...
      html.dark .sk-ann-fab--ghost:hover,
      html[data-theme="dark"] .sk-ann-card:hover,
      html[data-theme="dark"] .sk-ann-button--ghost:hover,
      html[data-theme="dark"] .sk-ann-fab--ghost:hover {
        background: #111827 !important;
      }
      html.dark .sk-ann-fab,
      html[data-theme="dark"] .sk-ann-fab {
        box-shadow: 0 18px 34px rgba(2, 6, 23, 0.46), 0 0 0 4px rgba(15, 23, 42, 0.94);
      }
      html.dark .sk-ann-fab--primary,
      html[data-theme="dark"] .sk-ann-fab--primary {
        background: #2563eb;
        border-color: #2563eb;
        color: #ffffff;
      }
      html.dark .sk-ann-fab--primary:hover,
      html[data-theme="dark"] .sk-ann-fab--primary:hover {
        background: #3b82f6;
        border-color: #3b82f6;
      }
      html.dark .sk-ann-fab--secondary,
      html[data-theme="dark"] .sk-ann-fab--secondary {
        background: #0f172a;
        border-color: #334155;
        color: #f8fafc;
      }
      html.dark .sk-ann-fab--secondary:hover,
      html[data-theme="dark"] .sk-ann-fab--secondary:hover {
        background: #111827;
        border-color: #475569;
      }
      html.dark .sk-ann-fab--danger,
      html[data-theme="dark"] .sk-ann-fab--danger {
        background: #ef4444;
        border-color: #ef4444;
        color: #ffffff;
      }
      html.dark .sk-ann-fab--danger:hover,
      html[data-theme="dark"] .sk-ann-fab--danger:hover {
        background: #f87171;
        border-color: #f87171;
      }
      html.dark .sk-ann-fab--ghost,
