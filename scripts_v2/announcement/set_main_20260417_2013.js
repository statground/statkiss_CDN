...
(function initStatkissAnnouncementShared() {
    ...
    function injectAnnouncementThemeFallback() {
      ...
      .sk-ann-fab {
        ...
        font-weight: 700;
        white-space: nowrap;
        box-shadow: 0 14px 28px rgba(15, 23, 42, 0.16), 0 0 0 4px rgba(255, 255, 255, 0.88);
        transition: transform 0.15s ease, background-color 0.15s ease, border-color 0.15s ease, color 0.15s ease, opacity 0.15s ease, box-shadow 0.15s ease;
        backdrop-filter: blur(12px);
      }
      .sk-ann-fab:hover {
        transform: translateY(-1px);
      }
      .sk-ann-fab:focus-visible {
        outline: none;
        box-shadow: 0 14px 28px rgba(15, 23, 42, 0.18), 0 0 0 4px rgba(255, 255, 255, 0.92), 0 0 0 7px rgba(59, 130, 246, 0.28);
      }
      .sk-ann-fab.is-disabled,
      .sk-ann-fab:disabled {
        cursor: not-allowed;
        opacity: 0.7;
        transform: none;
      ...
      .sk-ann-fab--primary:hover {
        background: #1d4ed8;
        border-color: #1d4ed8;
      }
      .sk-ann-fab--secondary {
        background: #0f172a;
        border-color: #0f172a;
        color: #ffffff;
      }
      .sk-ann-fab--secondary:hover {
        background: #020617;
        border-color: #020617;
      }
      .sk-ann-fab--danger {
      ...
      html[data-bs-theme="dark"] #div_main,
      body.dark #div_main,
      body[data-theme="dark"] #div_main,
      body[data-bs-theme="dark"] #div_main {
        background: #020617 !important;
        color: #ffffff !important;
      }
      html.dark #div_main .sk-ann-surface,
      html.dark #div_main .sk-ann-card,
      html.dark #div_main .sk-ann-soft,
      html.dark #div_main .sk-ann-input,
      html.dark #div_main .sk-ann-dropzone,
      html.dark #div_main .sk-ann-chip,
      html.dark #div_main .sk-ann-button--ghost,
      html.dark #div_main .sk-ann-fab--ghost,
      html.dark #div_main .toastui-editor-defaultUI,
      html.dark #div_main .toastui-editor-toolbar,
      html.dark #div_main .toastui-editor-popup,
      html.dark #div_main .toastui-editor-ww-container,
      html.dark #div_main .toastui-editor-md-container,
      html.dark #div_main .toastui-editor-mode-switch,
      html[data-theme="dark"] #div_main .sk-ann-surface,
      html[data-theme="dark"] #div_main .sk-ann-card,
      html[data-theme="dark"] #div_main .sk-ann-soft,
      html[data-theme="dark"] #div_main .sk-ann-input,
      html[data-theme="dark"] #div_main .sk-ann-dropzone,
      html[data-theme="dark"] #div_main .sk-ann-chip,
      html[data-theme="dark"] #div_main .sk-ann-button--ghost,
      html[data-theme="dark"] #div_main .sk-ann-fab--ghost,
      html[data-theme="dark"] #div_main .toastui-editor-defaultUI,
      html[data-theme="dark"] #div_main .toastui-editor-toolbar,
      html[data-theme="dark"] #div_main .toastui-editor-popup,
      html[data-theme="dark"] #div_main .toastui-editor-ww-container,
      html[data-theme="dark"] #div_main .toastui-editor-md-container,
      html[data-theme="dark"] #div_main .toastui-editor-mode-switch {
      ...
      html.dark #div_main .sk-ann-card:hover,
      html.dark #div_main .sk-ann-button--ghost:hover,
      html.dark #div_main .sk-ann-fab--ghost:hover,
      html[data-theme="dark"] #div_main .sk-ann-card:hover,
      html[data-theme="dark"] #div_main .sk-ann-button--ghost:hover,
      html[data-theme="dark"] #div_main .sk-ann-fab--ghost:hover {
        background: #111827 !important;
      }
      html.dark #div_main .sk-ann-fab,
      html[data-theme="dark"] #div_main .sk-ann-fab {
        box-shadow: 0 18px 34px rgba(2, 6, 23, 0.46), 0 0 0 4px rgba(15, 23, 42, 0.94);
      }
      html.dark #div_main .sk-ann-fab--primary,
      html[data-theme="dark"] #div_main .sk-ann-fab--primary {
        background: #2563eb;
        border-color: #2563eb;
        color: #ffffff;
      }
      html.dark #div_main .sk-ann-fab--primary:hover,
      html[data-theme="dark"] #div_main .sk-ann-fab--primary:hover {
        background: #3b82f6;
        border-color: #3b82f6;
      }
      html.dark #div_main .sk-ann-fab--secondary,
      html[data-theme="dark"] #div_main .sk-ann-fab--secondary {
        background: #0f172a;
        border-color: #334155;
        color: #f8fafc;
      }
      html.dark #div_main .sk-ann-fab--secondary:hover,
      html[data-theme="dark"] #div_main .sk-ann-fab--secondary:hover {
        background: #111827;
        border-color: #475569;
      }
      html.dark #div_main .sk-ann-fab--danger,
      html[data-theme="dark"] #div_main .sk-ann-fab--danger {
        background: #ef4444;
        border-color: #ef4444;
        color: #ffffff;
      }
      html.dark #div_main .sk-ann-fab--danger:hover,
      html[data-theme="dark"] #div_main .sk-ann-fab--danger:hover {
        background: #f87171;
        border-color: #f87171;
      }
      html.dark #div_main .sk-ann-fab--ghost,
      ...
      html.dark #div_main .text-slate-900,
      html.dark #div_main .text-slate-800,
      html.dark #div_main .text-slate-700,
      html.dark #div_main .text-slate-600,
      html.dark #div_main .text-slate-500,
      html.dark #div_main .text-slate-400,
      html[data-theme="dark"] #div_main .text-slate-900,
      html[data-theme="dark"] #div_main .text-slate-800,
      html[data-theme="dark"] #div_main .text-slate-700,
      html[data-theme="dark"] #div_main .text-slate-600,
      html[data-theme="dark"] #div_main .text-slate-500,
      html[data-theme="dark"] #div_main .text-slate-400 {
        color: #ffffff !important;
      }
      html.dark #div_main .bg-white,
      html.dark #div_main .bg-slate-50,
      html.dark #div_main .bg-slate-100,
      html.dark #div_main .bg-slate-200,
      html[data-theme="dark"] #div_main .bg-white,
      html[data-theme="dark"] #div_main .bg-slate-50,
      html[data-theme="dark"] #div_main .bg-slate-100,
      html[data-theme="dark"] #div_main .bg-slate-200 {
        background-image: none !important;
        box-shadow: none !important;
      }
      html.dark #div_main .bg-white,
      html[data-theme="dark"] #div_main .bg-white { background-color: #0f172a !important; }
      html.dark #div_main .bg-slate-50,
      html[data-theme="dark"] #div_main .bg-slate-50 { background-color: #0b1220 !important; }
      html.dark #div_main .bg-slate-100,
      html[data-theme="dark"] #div_main .bg-slate-100 { background-color: #111827 !important; }
      html.dark #div_main .bg-slate-200,
      html[data-theme="dark"] #div_main .bg-slate-200 { background-color: #1e293b !important; }
      html.dark #div_main .border-slate-100,
      html.dark #div_main .border-slate-200,
      html.dark #div_main .border-slate-300,
      html.dark #div_main .border-slate-400,
      html[data-theme="dark"] #div_main .border-slate-100,
      html[data-theme="dark"] #div_main .border-slate-200,
      html[data-theme="dark"] #div_main .border-slate-300,
      html[data-theme="dark"] #div_main .border-slate-400 {
        border-color: #334155 !important;
      }
      html.dark #div_main .sk-ann-content,
      html.dark #div_main .sk-ann-content *,
      html[data-theme="dark"] #div_main .sk-ann-content,
      html[data-theme="dark"] #div_main .sk-ann-content * {
        color: #ffffff !important;
        background-image: none !important;
        box-shadow: none !important;
      ...
      html.dark #div_main .sk-ann-content,
      html.dark #div_main .sk-ann-content *:not(table):not(thead):not(tbody):not(tfoot):not(tr):not(td):not(th):not(pre):not(code):not(blockquote),
      html[data-theme="dark"] #div_main .sk-ann-content,
      html[data-theme="dark"] #div_main .sk-ann-content *:not(table):not(thead):not(tbody):not(tfoot):not(tr):not(td):not(th):not(pre):not(code):not(blockquote) {
        background-color: transparent !important;
      }
      html.dark #div_main .sk-ann-content table,
      html.dark #div_main .sk-ann-content thead,
      html.dark #div_main .sk-ann-content tbody,
      html.dark #div_main .sk-ann-content tfoot,
      html.dark #div_main .sk-ann-content tr,
      html.dark #div_main .sk-ann-content td,
      html.dark #div_main .sk-ann-content th,
      html.dark #div_main .sk-ann-content pre,
      html.dark #div_main .sk-ann-content code,
      html.dark #div_main .sk-ann-content blockquote,
      html[data-theme="dark"] #div_main .sk-ann-content table,
      html[data-theme="dark"] #div_main .sk-ann-content thead,
      html[data-theme="dark"] #div_main .sk-ann-content tbody,
      html[data-theme="dark"] #div_main .sk-ann-content tfoot,
      html[data-theme="dark"] #div_main .sk-ann-content tr,
      html[data-theme="dark"] #div_main .sk-ann-content td,
      html[data-theme="dark"] #div_main .sk-ann-content th,
      html[data-theme="dark"] #div_main .sk-ann-content pre,
      html[data-theme="dark"] #div_main .sk-ann-content code,
      html[data-theme="dark"] #div_main .sk-ann-content blockquote {
        background: rgba(15, 23, 42, 0.72) !important;
        border-color: #334155 !important;
      }
      html.dark #div_main .sk-ann-content a,
      html[data-theme="dark"] #div_main .sk-ann-content a {
        color: #93c5fd !important;
      }
      html:not(.dark):not([data-theme="dark"]) #div_main .sk-ann-content,
      html:not(.dark):not([data-theme="dark"]) #div_main .sk-ann-content *:not(a):not(svg):not(path),
      html:not(.dark):not([data-theme="dark"]) #div_main .text-slate-900,
      html:not(.dark):not([data-theme="dark"]) #div_main .text-slate-800,
      html:not(.dark):not([data-theme="dark"]) #div_main .text-slate-700,
      html:not(.dark):not([data-theme="dark"]) #div_main .text-slate-600,
      html:not(.dark):not([data-theme="dark"]) #div_main .text-slate-500,
      html:not(.dark):not([data-theme="dark"]) #div_main .text-slate-400 {
        color: #000000 !important;
      }
      html.dark #div_main .toastui-editor-toolbar-icons,
      html.dark #div_main .toastui-editor-mode-switch .tab-item,
      html[data-theme="dark"] #div_main .toastui-editor-toolbar-icons,
      html[data-theme="dark"] #div_main .toastui-editor-mode-switch .tab-item {
        filter: invert(1) hue-rotate(180deg);
      }
      html.dark #div_main .sk-ann-editor-shell,
      html.dark #div_main .sk-ann-editor-fallback,
      html[data-theme="dark"] #div_main .sk-ann-editor-shell,
      html[data-theme="dark"] #div_main .sk-ann-editor-fallback {
        background: #0f172a !important;
        color: #ffffff !important;
        border-color: #334155 !important;
      }
      html.dark #div_main .sk-ann-editor-overlay,
      html[data-theme="dark"] #div_main .sk-ann-editor-overlay {
...
function set_main() {
    ...
    function FloatingActionDock({ actions }) {
        const items = Array.isArray(actions) ? actions.filter(Boolean) : [];
        if (items.length === 0) {
            return null;
        }
        return (React.createElement("div", { className: "sk-ann-fab-wrap", role: "group", "aria-label": "Announcement actions" }, items.map((action, index) => {
            const tone = action.tone || "secondary";
            const label = String(action.label || "");
            const key = action.key || `${tone}-${label || index}`;
            return (React.createElement("button", { key: key, type: "button", onClick: action.onClick, disabled: !!action.disabled, className: `sk-ann-fab sk-ann-fab--${tone}${action.disabled ? " is-disabled" : ""}` }, action.loading ? React.createElement(Spinner, { size: "h-4 w-4", tone: "text-current" }) : null, React.createElement("span", null, label)));
        })));
    }
    ...
    function ListApp() {
        ...
        const floatingActions = canManage ? [{
                key: "write",
                label: t("write", lang),
                tone: "primary",
                onClick: () => { window.location.href = buildPagePath("write"); },
            }] : [];
        return (React.createElement("div", { className: `py-6 px-4 mx-auto max-w-screen-xl sm:py-10 lg:px-6 space-y-8${floatingActions.length ? " pb-28 sm:pb-32" : ""}` },
            ...
            React.createElement(FloatingActionDock, { actions: floatingActions })));
    }
    function ReadApp() {
        ...
        const floatingActions = [
            canManage ? {
                key: "write",
                label: t("write", requestedLang),
                tone: "primary",
                onClick: () => { window.location.href = buildPagePath("write"); },
            } : null,
            canManage ? {
                key: "edit",
                label: t("edit", requestedLang),
                tone: "secondary",
                onClick: () => { window.location.href = buildPagePath("edit", ctx.uuid); },
            } : null,
            canManage ? {
                key: "delete",
                label: t("delete", requestedLang),
                tone: "danger",
                onClick: handleDelete,
            } : null,
            {
                key: "list",
                label: t("list", requestedLang),
                tone: "ghost",
                onClick: () => { window.location.href = buildPagePath(); },
            },
        ];
        return (React.createElement("div", { className: "py-6 px-4 mx-auto max-w-screen-xl sm:py-10 lg:px-6 pb-28 sm:pb-32" },
            React.createElement("article", { className: "sk-ann-surface overflow-hidden rounded-3xl border border-slate-200 bg-slate-50 shadow-sm" },
                ...
                React.createElement("footer", { className: "border-t border-slate-200 bg-slate-50 px-6 py-2 md:px-8" })),
            React.createElement(FloatingActionDock, { actions: floatingActions })));
    }
    ...
    function EditorApp() {
        ...
        const floatingActions = [
            {
                key: isEditMode ? "save-edit" : "submit-write",
                label: saving ? t("saving", lang) : t("submit", lang),
                tone: "primary",
                onClick: handleSubmit,
                disabled: saving || loading || (!editorReady && !editorFailed),
                loading: saving,
            },
            {
                key: "list",
