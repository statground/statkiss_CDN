...
(function initStatkissAnnouncementShared() {
    ...
    function isAnnouncementDarkTheme() {
        ...
        if (!root)
            return false;
        const htmlTheme = String(root.getAttribute("data-theme") || root.getAttribute("data-bs-theme") || root.getAttribute("data-mode") || root.getAttribute("data-statkiss-theme") || "").toLowerCase();
        const bodyTheme = body ? String(body.getAttribute("data-theme") || body.getAttribute("data-bs-theme") || body.getAttribute("data-mode") || body.getAttribute("data-statkiss-theme") || "").toLowerCase() : "";
