...
function is_awards_dark_mode() {
    ...
    try {
        ...
        return !!(
            (doc && (doc.classList.contains("dark") || doc.getAttribute("data-theme") === "dark" || doc.getAttribute("data-bs-theme") === "dark" || doc.getAttribute("data-mode") === "dark" || doc.getAttribute("data-statkiss-theme") === "dark")) ||
            (body && (body.classList.contains("dark") || body.getAttribute("data-theme") === "dark" || body.getAttribute("data-bs-theme") === "dark" || body.getAttribute("data-mode") === "dark" || body.getAttribute("data-statkiss-theme") === "dark"))
        );
    } catch (error) {
        return false;
    }
