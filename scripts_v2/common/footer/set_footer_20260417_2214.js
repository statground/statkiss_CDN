function Div_footer() {
  ...
  (function injectFooterDarkFallback() {
    ...
    style.textContent = `
      ...
      html[data-statkiss-theme="dark"] footer#div_footer .footer-muted { color: #94a3b8 !important; }
      html.dark footer#div_footer a,
      html[data-theme="dark"] footer#div_footer a,
      html[data-statkiss-theme="dark"] footer#div_footer a { color: inherit !important; }
      html.dark footer#div_footer img,
      html[data-theme="dark"] footer#div_footer img,
      html[data-statkiss-theme="dark"] footer#div_footer img { filter: invert(1); opacity: .9; }
    `;
