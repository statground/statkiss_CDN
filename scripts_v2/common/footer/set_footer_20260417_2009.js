function Div_footer() {
  ...
  (function injectFooterDarkFallback() {
    ...
    style.textContent = `
      :is(html.dark, body.dark, html[data-theme="dark"], body[data-theme="dark"], html[data-bs-theme="dark"], body[data-bs-theme="dark"], html[data-statkiss-theme="dark"], body[data-statkiss-theme="dark"]) footer#div_footer {
        background: #020617 !important;
        color: #cbd5e1 !important;
        border-top: 1px solid rgba(148,163,184,0.14) !important;
      }
      :is(html.dark, body.dark, html[data-theme="dark"], body[data-theme="dark"], html[data-bs-theme="dark"], body[data-bs-theme="dark"], html[data-statkiss-theme="dark"], body[data-statkiss-theme="dark"]) footer#div_footer .footer-muted { color: #94a3b8 !important; }
      :is(html.dark, body.dark, html[data-theme="dark"], body[data-theme="dark"], html[data-bs-theme="dark"], body[data-bs-theme="dark"], html[data-statkiss-theme="dark"], body[data-statkiss-theme="dark"]) footer#div_footer a { color: inherit !important; }
      :is(html.dark, body.dark, html[data-theme="dark"], body[data-theme="dark"], html[data-bs-theme="dark"], body[data-bs-theme="dark"], html[data-statkiss-theme="dark"], body[data-statkiss-theme="dark"]) footer#div_footer img { filter: invert(1); opacity: .9; }
    `;
