...
function set_main() {
  ...
  (function injectDarkFallback(){
    ...
    style.textContent = `
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) body { background-color:#020617; color:#e2e8f0; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg { background-color:#020617; color:#e2e8f0; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-card { background-color:#0b1220 !important; border-color:rgba(148,163,184,0.14) !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-muted { color:#94a3b8 !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-border { border-color:rgba(148,163,184,0.14) !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-hover:hover { background-color:#111827 !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-chip { background-color:#111827 !important; color:#e2e8f0 !important; }
    
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bg-white { background-color:#0b1220 !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bg-slate-50 { background-color:#020617 !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .text-slate-900,
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .text-slate-800 { color:#e2e8f0 !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .text-slate-700,
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .text-slate-600,
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .text-slate-500 { color:#cbd5e1 !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .text-slate-400 { color:#94a3b8 !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .border-slate-100,
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .border-slate-200 { border-color:rgba(148,163,184,0.14) !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .divide-slate-50 { border-color:rgba(148,163,184,0.14) !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bg-indigo-50 { background-color:#0f172a !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bg-slate-100 { background-color:#0f172a !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .text-indigo-600 { color:#93c5fd !important; }
      \n      \n      
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-item.border { border: none !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .shadow-xl,
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .shadow-lg,
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .shadow-md { box-shadow: 0 18px 44px rgba(0,0,0,.35) !important; }
    
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bg-slate-100.text-slate-500 { color:#cbd5e1 !important; }

      /* Bulletin container background fix (Tailwind class with slash) */
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bg-slate-50\/50 { background-color: rgba(255,255,255,0.03) !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bg-slate-50\/50 * { border-color: rgba(255,255,255,0.06) !important; }
      
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-item .bg-indigo-50 { background-color: rgba(59,130,246,0.16) !important; }
    
      /* Fix hover turning white on dark backgrounds */
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .latest-item:hover { background-color: rgba(255,255,255,0.08) !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .latest-item:hover * { color: inherit !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .latest-item .text-indigo-600 { color:#93c5fd !important; }
    
      /* Unified dark card styling for Bulletin */
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-item { background-color: #0b1220 !important; border: none !important; box-shadow: none !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-item:hover {
        background-color: #111827 !important;
      }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-item .text-slate-800,
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-item .text-slate-900 {
        color: #e2e8f0 !important;
      }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-item .text-slate-500,
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-item .text-slate-400 {
        color: #94a3b8 !important;
      }
    
      /* Soften outer Bulletin section border */
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .rounded-3xl { border: none !important; }

      /* Bulletin card borders thinner + subtle */
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-item { background-color: #0b1220 !important; border: none !important; box-shadow: none !important; }

      /* Remove heavy inner separators */
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .divide-slate-50 {
        border-color: rgba(148,163,184,0.06) !important;
      }
    
      /* Force-remove borders in Bulletin section on dark mode */
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-section,
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-section * {
        outline: none !important;
      }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-section .border,
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-section [class*="border-"],
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-section [class~="border"] {
        border: none !important;
      }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-item,
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg a.bulletin-item {
        border: none !important;
        outline: none !important;
      ...
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-list {
      ...
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-list.bg-slate-50\/50 { background: transparent !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-list * { outline: none !important; }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-item {
        border: none !important;
        box-shadow: none !important;
        outline: none !important;
      }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-item:hover { box-shadow: none !important; }
      
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-section .bulletin-list {
        background: transparent !important;
        padding: 0 !important;
        border: none !important;
        box-shadow: none !important;
      }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-section .bulletin-list.bg-slate-50\/50 {
        background: transparent !important;
      }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-section .bulletin-list > * {
        border: none !important;
      ...
      */
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-section .bulletin-list,
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-section .bulletin-list.bg-slate-50\/50,
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-section .bg-slate-50\/50 {
        background: transparent !important;
        padding: 0 !important;
        border: none !important;
        box-shadow: none !important;
      ...
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-section a,
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-section a * {
        border: none !important;
        outline: none !important;
        box-shadow: none !important;
      ...
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-section .bulletin-item {
        background-color: #0b1220 !important;
        border: none !important;
        box-shadow: none !important;
      }
      :is(html.dark, html[data-theme="dark"], body.dark, body[data-theme="dark"]) .kiss-main-bg .bulletin-section .bulletin-item:hover {
        background-color: #111827 !important;
      }
    `;
