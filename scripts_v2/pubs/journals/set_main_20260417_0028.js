function set_main() {
    ...
    function isDarkModeEnabled() {
        ...
        try {
            ...
            const htmlTheme = (html && (html.getAttribute('data-theme') || html.getAttribute('data-bs-theme') || html.getAttribute('data-mode') || html.getAttribute('data-statkiss-theme') || html.getAttribute('theme'))) || '';
            const bodyTheme = (body && (body.getAttribute('data-theme') || body.getAttribute('data-bs-theme') || body.getAttribute('data-mode') || body.getAttribute('data-statkiss-theme') || body.getAttribute('theme'))) || '';
    ...
    function App() {
        ...
        React.useEffect(() => {
            ...
            observer.observe(document.documentElement, { attributes: true, attributeFilter: ['lang', 'dir', 'class', 'data-theme', 'data-bs-theme', 'data-mode', 'data-statkiss-theme', 'theme'] });
