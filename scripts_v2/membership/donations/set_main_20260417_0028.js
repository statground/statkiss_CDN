(function() {
  ...
  function isDarkModeEnabled() {
    ...
    const attrCandidates = [
      ...
      root ? root.getAttribute('data-bs-theme') : '',
      root ? root.getAttribute('data-statkiss-theme') : '',
      body ? body.getAttribute('data-theme') : '',
      body ? body.getAttribute('data-mode') : '',
      body ? body.getAttribute('data-color-mode') : '',
      body ? body.getAttribute('data-bs-theme') : '',
      body ? body.getAttribute('data-statkiss-theme') : ''
  ...
  function setupObservers() {
    ...
    observer.observe(document.documentElement, {
      attributes: true,
      attributeFilter: ['class', 'lang', 'dir', 'data-theme', 'data-mode', 'data-color-mode', 'data-bs-theme', 'data-statkiss-theme']
    });
    if (document.body) {
      observer.observe(document.body, {
        attributes: true,
        attributeFilter: ['class', 'data-theme', 'data-mode', 'data-color-mode', 'data-bs-theme', 'data-statkiss-theme']
      });
    }
